...
| "The customer's request is small, I can do it in one pass without decomposition" | One-pass synthesis hides bundled capabilities. A request that looks like "send us a CSV" but contains 6+ distinct asks with very different effort profiles. Always decompose. |
